export default {
    ...
    const visualization= { /* ...configuration ... */ };
    ...
    const storyConfig = {
      ...
      sectionList: [ 
        ...
        visualization, // section configuration
      ],
    };
  ...
  const visualization= { // Section Config object
    sectionIdentifier: 'visualization',
    ...
    sectionConfigFlow: `
  const visualization= { // Section Config
