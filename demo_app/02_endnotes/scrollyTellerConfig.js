...
export default {
    ...
    narration: 'demo_app/02_endnotes/data/narration.csv',
    ...
    buildGraphFunction: function buildGraph(graphId, sectionConfig) {
        ...
        updateImage(graphId, { imgFileName: 'JPP-Logo-New-1.png' }, sectionState.imgFileName);
        sectionState.imgFileName = 'JPP-Logo-New-1.png';
        return undefined;
    },
